...
ava('.measureMirror() should update the mirror execution counter', async (test) => {
	let result = await getMetrics()
	test.truthy(result.body.includes(`jf_mirror_duration_seconds_count{type="${test.context.integration}"} 1`))

	await metrics.measureMirror(test.context.integration, test.context.func)
	result = await getMetrics()
	test.truthy(result.body.includes(`jf_mirror_duration_seconds_count{type="${test.context.integration}"} 2`))
})

ava('.measureTranslate() should update translate execution counter', async (test) => {
	let result = await getMetrics()
	test.truthy(result.body.includes(`jf_translate_duration_seconds_count{type="${test.context.integration}"} 1`))

	metrics.measureTranslate(test.context.integration, test.context.func)
	result = await getMetrics()
	test.truthy(result.body.includes(`jf_translate_duration_seconds_count{type="${test.context.integration}"} 2`))
})

ava('.measureHttpQuery() should increment the /query request counter', async (test) => {
	let result = await getMetrics()
	...
	test.truthy(result.body.includes('jf_http_api_query_duration_seconds_count 2'))
})

ava('.measureHttpType() should increment the /type request counter', async (test) => {
	let result = await getMetrics()
	...
	test.truthy(result.body.includes('jf_http_api_type_duration_seconds_count 2'))
})

ava('.measureHttpId() should increment the /id request counter', async (test) => {
	let result = await getMetrics()
	...
	test.truthy(result.body.includes('jf_http_api_id_duration_seconds_count 2'))
})

ava('.measureHttpSlug() should increment the /slug request counter', async (test) => {
	let result = await getMetrics()
	...
	test.truthy(result.body.includes('jf_http_api_slug_duration_seconds_count 2'))
})

ava('.measureHttpAction() should increment the /action request counter', async (test) => {
	let result = await getMetrics()
	...
	test.truthy(result.body.includes('jf_http_api_action_duration_seconds_count 2'))
})

ava('.measureHttpWhoami() should increment the /whoami request counter', async (test) => {
	let result = await getMetrics()
	...
	test.truthy(result.body.includes('jf_http_whoami_query_duration_seconds_count 2'))
})
