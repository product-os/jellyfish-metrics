...
exports.measureTranslate = async (integration, fn) => {
	...
	const results = await measureAsync(descriptions.names.TRANSLATE_DURATION, labels, fn).catch((err) => {
		metrics.inc(descriptions.names.TRANSLATE_FAILURE_TOTAL, 1, labels)
		throw err
	})
	return results
}
