 ...
 * Worker metric names
 */
export interface WorkerMetricNames extends Pick<MetricName, 'total' | 'saturation' | 'jobDuration' | 'concurrency'> {};
 ...
 */
export interface StreamMetricNames extends Pick<MetricName, 'total' | 'saturation' | 'errorTotal'> {};

/**
 * Common async measure metric names
 */
export interface MeasureMetricNames extends Pick<MetricName, 'total' | 'durationSeconds' | 'failureTotal'> {};
